...
NOTE: Spring Boot is based on com.peng.JavaConfig and
...
class IntegrationTests {
  ...
  val application = com.peng.Application(8181)
...
* https://github.com/spring-petclinic/spring-petclinic-kotlin[spring-petclinic-kotlin]: Kotlin version of the Spring PetClinic Sample com.peng.Application
