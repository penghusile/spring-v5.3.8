...
[[resources-app-ctx]]
== com.peng.Application Contexts and Resource Paths
...
=== Constructing com.peng.Application Contexts
...
=== Wildcards in com.peng.Application Context Constructor Resource Paths
